...
export default function UltimatelyRetentionPage() {
  ...
  return (
    <WizardShell
      eyebrow="ULTIMATELY · Business Retention"
      ...
      backHref="/ultimately/distribution"
      nextHref="/ultimately/capacity"
    >
      ...
      {capitalItems.length === 0 && (
        <p className="text-xs text-ink/50">If the mature business doesn&rsquo;t need to retain anything, that&rsquo;s a valid answer too — leave this empty.</p>
      )}
    </WizardShell>
  );
}
